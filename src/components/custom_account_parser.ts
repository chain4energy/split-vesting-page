...
import {PeriodicContinuousVestingAccount} from "./periodicContinousVestingAccount/vesting_account";
...
export interface VestingBaseAccount {
  address: string;
...
function accountFromBaseAccount(input: BaseAccount | VestingBaseAccount): Account {
